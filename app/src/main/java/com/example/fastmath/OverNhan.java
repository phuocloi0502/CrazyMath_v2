...
public class OverNhan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_Try.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(OverNhan.this,PlayNhan.class);
                startActivity(intent);
                OverNhan.this.finish();
            }
        });
        btn_Home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mysounds.play(clicksound, 1.0f, 1.0f, 1, 0, 1);
                Intent intent=new Intent(OverNhan.this,MainActivity.class);
    ...
    public void soundHome() {
        overl = MediaPlayer.create(OverNhan.this, R.raw.wrong2);
